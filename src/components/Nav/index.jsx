  ...
  return (
      <Menu as="div" className="relative flex text-left p-2 justify-between align-middle shadow-md z-100">
          <Menu.Button as='img' alt='Leesey Logo' src={require('../../assets/leesey_logo_rabbit.PNG')}
            className="inline-flex text-warm-white justify-center w-[15%] p-1 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-red-accent">
          </Menu.Button>
        <ul className='p-2 '>
